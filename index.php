      ...
      <div class="card mt-5 px-3 py-4">
        ...
        <div class="media mt-3 pl-2">
            ...
            <form class="row g-3" action="./stk_initiate.php" method="POST">
                 ...
                 <!-- Read-only field for the amount -->
                <div class="col-12">
                 <label for="inputAdress1" class="form-label">Amount To Pay</label>
                 <input type="text" name="amount_display" value="<?php echo htmlspecialchars($_POST['amount']); ?>" readonly>
                </div>
                <div class="col-12">
